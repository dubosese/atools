...
class RandomSpherePattern(mb.Pattern):
    def __init__(self, n, seed=12345, **kwargs):
        ...
        super(RandomSpherePattern, self).__init__(points=points, **kwargs)

if __name__ == "__main__":
    pattern = RandomSpherePattern(n=1000, radius=1.0)
    ...
    lj_box.save('sphere.xyz', overwrite=True)
